 ...
 * @version    CVS: $Id: Span.php,v 1.1 2007/08/21 13:51:25  Exp $
 ...
 * Get the Date class
 */
require_once dirname(dirname(__FILE__)) . '/Date.php';
 ...
 *
 * @to-do       Get and set default local input and output formats?
 */
class Date_Span {
