...
if($order->id == 0)
{
	...
	<p><input type="button" value="Change delivery address" onclick="window.open('shopping_cart_address.php?action=select_delivery_address', '_self'); " class="button"></p>
	...
	<p><input type="button" value="<?php echo htmlspecialchars(translate("Change invoicing address")); ?>" onclick="window.open('shopping_cart_address.php?action=select_invoice_address', '_self'); " class="button"></p>
	<?php
}
else {
	?>
