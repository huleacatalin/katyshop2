...
function template_include_shopping_cart_box() {
	...
	if (!$user->isAdminLoggedIn()) {
		...
		<h1><a href="shopping_cart.php"><?php echo htmlspecialchars(translate("Shopping cart")); ?></a></h1>
		<?php
		...
		else
		{
			...
			for($i = 0; $i < $basket->getProductsCount(); $i++)
			{
				...
				?>
				<li>
					<a href="javascript:removeOrderProduct('<?php echo intval($op->line_number); ?>'); " title="remove product"><img src="html/book-store/img/icons/delete.png" alt="remove product"></a>
