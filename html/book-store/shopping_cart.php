...
else
{
	...
	for($i = 0; $i < $basket->getProductsCount(); $i++)
	{
		...
		?>
		<tr>
		<td><a href="javascript:removeOrderProduct('<?php echo intval($op->line_number); ?>'); " title="remove product"><img src="html/book-store/img/icons/delete.png" alt="remove product"></a></td>
		<td>
