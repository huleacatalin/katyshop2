		...
		<div id="main">
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
<main>
<h2><?php echo htmlspecialchars(translate("Processing order: step 1")); ?><span class="title-bottom">&nbsp;</span></h2>
<?php require_once(dirname(__FILE__) . "/includes/print_messages.php"); ?>

<h2><?php echo htmlspecialchars(translate("Shopping cart")); ?><span class="title-bottom">&nbsp;</span></h2>
...
else
{
	...
	<table style="text-align: right; margin-top: 1em; " cellpadding="2" cellspacing="0" class="cuborder">
	<tr align="center">
	<th>&nbsp;</th>
	...
	for($i = 0; $i < $basket->getProductsCount(); $i++)
	{
		...
		?>
		<tr>
		<td><a href="javascript:removeOrderProduct('<?php echo intval($op->line_number); ?>'); " title="remove product"><img src="html/PCStore/img/icons/delete.png" alt="remove product"></a></td>
		<td>
