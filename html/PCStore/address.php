		...
		<div id="main">
			...
			<div class="inner">
				<div class="shell">
					...
					<div id="content">
<main>
<h2><?php echo htmlspecialchars(translate("My addresses")); ?><span class="title-bottom">&nbsp;</span></h2>
...
if(@$_GET["detail"] == "true")
{
	...
	<h2><?php echo ($address->id == 0) ? htmlspecialchars(translate('Add new address')) : htmlspecialchars(translate('Edit address')); ?><span class="title-bottom">&nbsp;</span></h2>
	...
	if($address->id > 0) {
		?>
		<input type="button" value="<?php echo htmlspecialchars(translate('Delete')); ?>" style="color: red; margin-left: 1em; " onclick="deleteAddress(); " class="button">
		<?php
	}
	?>
	</form>
