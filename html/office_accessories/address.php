	...
	if(count($addresses) > 0)
	{
		for($i = 0; $i < count($addresses); $i++)
		{
			...
			<td>
				...
				<input type="hidden" name="id" value="<?php echo intval($a->id); ?>">
				<input type="submit" value="<?php echo htmlspecialchars(translate("Delete")); ?>" style="color: red; " class="button">
				</form>
			</td>
			<td>
				<a href="address.php?detail=true&id=<?php echo intval($a->id); ?>"><?php echo htmlspecialchars(translate("County")); ?> <?php echo htmlspecialchars($a->county); ?></a><br>
				<a href="address.php?detail=true&id=<?php echo intval($a->id); ?>"><?php echo htmlspecialchars(translate("City")); ?> <?php echo htmlspecialchars($a->city); ?></a><br>
				<a href="address.php?detail=true&id=<?php echo intval($a->id); ?>"><?php echo htmlspecialchars($a->address); ?></a>
			</td>
			</tr>
			</table>
			<?php
