	...
	if (!$user->isAdminLoggedIn()) {
		...
		else
		{
			...
			for($i = 0; $i < $basket->getProductsCount(); $i++)
			{
				...
				?>
				<li>
					<a href="javascript:removeOrderProduct('<?php echo intval($op->line_number); ?>'); " title="remove product"><img src="html/office_accessories/img/icons/delete.png" alt="remove product"></a>
